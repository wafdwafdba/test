...
*/
$.extend({
    messageBox0s: function (title, msg) {
        $.messager.show({
            title: title, msg: msg, timeout: 0, showType: 'slide', style: {
                left: '',
                right: 5,
                top: '',
...
$.extend({
    messageBox: function (title, msg) {
        $.messager.show({
            title: title, msg: msg, height: '100', width: '200', timeout: 86400000, showType: 'slide', style: {
                left: '',
                right: 5,
                top: '',
                bottom: -document.body.scrollTop - document.documentElement.scrollTop + 5
