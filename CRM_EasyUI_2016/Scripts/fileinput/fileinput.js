...
(function ($) {
    ...
    //   这一行不需要了         '    <div class="close fileinput-remove">&times;</div>\n' +
            '    <div class="{dropClass}">\n' +
    ...
    //            '    <div class="file-caption-name">{caption}</div>\n' +
        ...
        tActionUpload = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">' +
            '   {uploadIcon}\n</button>\n',
        tGeneric = '<div class="file-preview-frame{frameClass}" onclick="deleteFile(this)" onmouseover="showFile(this)" onmouseout="hideFile(this)" id="{previewId}" data-fileindex="{fileindex}">\n' +
            '   {content}\n' +
               '   <div class="cp_img_jian" />\n' +
              '   <div class="successinfo">√</div>\n' +
            '   {footer}\n' +
            '</div>\n',
        tHtml = '<div class="file-preview-frame{frameClass}" onclick="deleteFile(this)" onmouseover="showFile(this)" onmouseout="hideFile(this)"  id="{previewId}" data-fileindex="{fileindex}">\n' +
            ...
            '   {footer}\n' +
            '</div>',
        tImage = '<div class="file-preview-frame{frameClass}"  onclick="deleteFile(this)" onmouseover="showFile(this)" onmouseout="hideFile(this)" id="{previewId}" data-fileindex="{fileindex}">\n' +
            '   <img src="{data}" class="file-preview-image" title="{caption}" alt="{caption}" ' + STYLE_SETTING + '>\n' +
              '   <div class="cp_img_jian" />\n' +
              '   <div class="successinfo">√</div>\n' +
            '   {footer}\n' +
            '</div>\n',
        tText = '<div class="file-preview-frame{frameClass}" onclick="deleteFile(this)" onmouseover="showFile(this)" onmouseout="hideFile(this)" id="{previewId}" data-fileindex="{fileindex}">\n' +
            '   <div class="file-preview-text" title="{caption}" ' + STYLE_SETTING + '>\n' +
            '       {data}\n' +
            '   </div>\n' +
            '   {footer}\n' +
            '</div>',
        tVideo = '<div class="file-preview-frame{frameClass}" onclick="deleteFile(this)" onmouseover="showFile(this)" onmouseout="hideFile(this)" id="{previewId}" data-fileindex="{fileindex}"' +
            ...
            '   {footer}\n' +
            '</div>\n',
        tAudio = '<div class="file-preview-frame{frameClass}" onclick="deleteFile(this)" onmouseover="showFile(this)" onmouseout="hideFile(this)" id="{previewId}" data-fileindex="{fileindex}"' +
            ' title="{caption}" ' + STYLE_SETTING + '>\n' +
            '   <audio controls>\n' +
            '       <source src="' + '{data}' + '" type="{type}">\n' +
            '       ' + DEFAULT_PREVIEW + '\n' +
            ...
            '   {footer}\n' +
            '</div>',
        tFlash = '<div class="file-preview-frame{frameClass}" onclick="deleteFile(this)" onmouseover="showFile(this)" onmouseout="hideFile(this)" id="{previewId}" data-fileindex="{fileindex}"' +
            ' title="{caption}" ' + STYLE_SETTING + '>\n' +
            ...
            '   {footer}\n' +
            '</div>\n',
        tObject = '<div class="file-preview-frame{frameClass}" onclick="deleteFile(this)" onmouseover="showFile(this)" onmouseout="hideFile(this)" id="{previewId}" data-fileindex="{fileindex}"' +
            ' title="{caption}" ' + STYLE_SETTING + '>\n' +
            '   <object data="{data}" type="{type}" width="{width}" height="{height}">\n' +
            ...
            '   {footer}\n' +
            '</div>',
        tOther = '<div class="file-preview-frame{frameClass}" onclick="deleteFile(this)" onmouseover="showFile(this)" onmouseout="hideFile(this)" id="{previewId}" data-fileindex="{fileindex}"' +
            ' title="{caption}" ' + STYLE_SETTING + '>\n' +
            '   ' + DEFAULT_PREVIEW + '\n' +
               '   <div class="cp_img_jian" />\n' +
              '   <div class="successinfo">√</div>\n' +
...
function showFile(v) {
    $(v).children(".cp_img_jian").css("display", "block");
}
function hideFile(v) {
    $(v).children(".cp_img_jian").css("display", "none");
}

function deleteFile(e) {
    $(e).remove();
    var vfileLength = $(".file-preview-thumbnails").children().length>0?true:false;
    if(!vfileLength)
    {
        $(".file-preview").hide();
    }
